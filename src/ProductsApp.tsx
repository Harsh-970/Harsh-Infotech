  ...
  return (
    <div className="min-h-screen selection:bg-white selection:text-black">
      ...
      <main className="pt-8 pb-16 md:pb-24 lg:pb-32">
        ...
        <div className="flex flex-col gap-12 md:gap-20 lg:gap-24 px-4 sm:px-6 lg:px-20 max-w-7xl mx-auto">
          {products.map((prod, i) => (
            <motion.section 
              ...
              className={`flex flex-col gap-8 md:gap-16 items-center glass-card p-6 sm:p-10 lg:p-16 scroll-mt-32 relative ${i % 2 === 1 ? 'md:flex-row-reverse' : 'md:flex-row'}`}
            >
